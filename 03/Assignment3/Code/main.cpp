...
Eigen::Vector3f bump_fragment_shader(const fragment_shader_payload& payload)
{
    ...
    auto huv = payload.texture->getColorBilinear(u, v).norm();

    float dU = kh * kn * (payload.texture->getColorBilinear(u + 1.0f / w, v).norm() - huv);
    float dV = kh * kn * (payload.texture->getColorBilinear(u, v + 1.0f / h).norm() - huv);
...
int main(int argc, const char** argv)
{
    ...
    objl::Loader Loader;
    std::string obj_path = "D:/Hw3/Assignment3/Code/models/spot/";

    // Load .obj File
    bool loadout = Loader.LoadFile("D:/Hw3/Assignment3/Code/models/spot/spot_triangulated_good.obj");
